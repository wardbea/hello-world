...
//import { FormDisplayMode, Log } from '@microsoft/sp-core-library';  //initial declaration
...
export default class CustomersFormCustomizer
  ...
  public async onInit(): Promise<void> {
    ...
    if (this.displayMode !== FormDisplayMode.New) {
      ...
      const response: ICustomer = await SharePointService.getCustomer(Number(this.context.itemId), this.context.list.title);
  ...
  public render(): void {
    ...
    const FCPlayground: React.ReactElement<{}> =
      ...
      } as unknown as IFormContainerProps);
